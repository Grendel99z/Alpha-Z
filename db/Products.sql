...
('alpha', 'PC', 3000.00, 25, 'a high-end PC that''s perfect for everyday use. With a fast processor and ample storage, this PC can handle everything from web browsing to document editing. Its compact design makes it a great choice for small spaces.', 'PC/alpha'),
('beta', 'PC', 4000.00, 30, 'a high-end PC that''s perfect for home or office use. With a reliable processor and plenty of storage, this PC can handle everyday tasks with ease. Its simple design and energy-efficient components make it an eco-friendly choice.', 'PC/beta');
...
('boltbook', 'Laptop', 3000.00, 30, 'a high-end laptop that''s perfect for home or office use. With a reliable processor and plenty of storage, this laptop can handle everyday tasks with ease. Its simple design and energy-efficient components make it an eco-friendly choice.', 'Laptop/boltbook');
