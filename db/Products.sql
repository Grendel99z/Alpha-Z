...
('alpha', 'PC', 1700.00, 25, 'a budget-friendly PC that''s perfect for everyday use. With a fast processor and ample storage, this PC can handle everything from web browsing to document editing. Its compact design makes it a great choice for small spaces.', 'PC/alpha.png'),
('beta', 'PC', 2000.00, 30, 'a basic PC that''s perfect for home or office use. With a reliable processor and plenty of storage, this PC can handle everyday tasks with ease. Its simple design and energy-efficient components make it an eco-friendly choice.', 'PC/beta.png');
