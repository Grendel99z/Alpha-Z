...
('alpha', 'PC', 700.00, 25, 'a high-end PC that''s perfect for everyday use. With a fast processor and ample storage, this PC can handle everything from web browsing to document editing. Its compact design makes it a great choice for small spaces.', 'PC/alpha'),
('beta', 'PC', 600.00, 30, 'a high-end that''s perfect for home or office use. With a reliable processor and plenty of storage, this PC can handle everyday tasks with ease. Its simple design and energy-efficient components make it an eco-friendly choice.', 'PC/beta');
...
('stream', 'Laptop', 2500.00, 25, 'a high-end laptop that''s perfect for everyday use. With a fast processor and ample storage, this laptop can handle everything from web browsing to document editing. Its compact design makes it a great choice for small spaces.', 'Laptop/stream'),
('boltbook', 'Laptop', 3000.00, 30, 'a high-end that''s perfect for home or office use. With a reliable processor and plenty of storage, this laptop can handle everyday tasks with ease. Its simple design and energy-efficient components make it an eco-friendly choice.', 'Laptop/boltbook');
...
('Yeti', 'Microphone', 130.00, 5, 'a professional-grade USB microphone with four different polar patterns and built-in headphone jack. With a sleek design and easy-to-use controls, this mic is perfect for podcasters, streamers, and musicians.', 'accessories/mic/Yeti'),
('Snowball', 'Microphone', 70.00, 10, 'a versatile USB microphone with two different polar patterns and adjustable stand. With a compact design and plug-and-play functionality, this mic is perfect for home studios and on-the-go recording.', 'accessories/mic/Snowball'),
